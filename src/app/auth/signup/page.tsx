...
const roleInfo = {
  agent: {
    icon: Briefcase,
    title: 'Agent',
    subtitle: 'Field Agent / Sales Rep',
    description: 'Create transactions, record receipts & payments, and track your commissions.',
    color: 'border-blue-200 dark:border-blue-800 bg-blue-50/60 dark:bg-blue-900/20',
    selectedColor: 'border-blue-500 ring-2 ring-blue-200 dark:ring-blue-800 bg-blue-50 dark:bg-blue-900/30',
...
export default function SignUp() {
  ...
  if (success) {
    return (
      <div className="min-h-screen flex items-center justify-center bg-white dark:bg-gray-900 px-5">
        <div className="max-w-sm w-full text-center">
          ...
          <Link 
            href="/auth/signin" 
            className="inline-flex items-center gap-2 bg-dubai-gradient text-white font-semibold py-3 px-8 rounded-xl shadow-dubai hover:shadow-lg hover:brightness-110 transition-all group"
          >
  ...
  const inputClass = (field: string) => `relative rounded-xl border-2 transition-all duration-200 ${
    errors[field]
            ...
            <form onSubmit={handleSubmit} className="space-y-6">
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 sm:gap-5">
                <div>
                  ...
                  {errors.name && <p className="text-danger text-xs mt-1.5 flex items-center gap-1"><span className="inline-block w-1 h-1 rounded-full bg-danger" />{errors.name}</p>}
                </div>
                ...
                <div>
                  ...
                  {errors.email && <p className="text-danger text-xs mt-1.5 flex items-center gap-1"><span className="inline-block w-1 h-1 rounded-full bg-danger" />{errors.email}</p>}
                </div>
              </div>
              ...
              <div>
                ...
                {formData.password && (
                  <div className="mt-2 flex items-center gap-2">
                    ...
                    <span className="text-[11px] text-gray-400 dark:text-gray-500 font-medium">{strengthLabel}</span>
                  </div>
                )}
                {errors.password && <p className="text-danger text-xs mt-1.5 flex items-center gap-1"><span className="inline-block w-1 h-1 rounded-full bg-danger" />{errors.password}</p>}
              </div>
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 sm:gap-5">
                <div>
                  ...
                  {errors.phone && <p className="text-danger text-xs mt-1.5 flex items-center gap-1"><span className="inline-block w-1 h-1 rounded-full bg-danger" />{errors.phone}</p>}
                </div>
