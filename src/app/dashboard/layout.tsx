  ...
  return (
    <div className="h-screen flex overflow-hidden bg-gray-50 dark:bg-gray-900">
      ...
      <div className={`fixed inset-0 flex z-40 md:hidden ${sidebarOpen ? '' : 'hidden'}`}>
        ...
        <div className="relative flex-1 flex flex-col max-w-[280px] w-full bg-[#111827] shadow-2xl">
          ...
          <div className="flex flex-col h-full bg-[#111827]">
            ...
            <div className="flex-shrink-0 border-t border-white/[0.06] p-3">
              <button 
                ...
                className="w-full flex items-center px-3 py-2.5 text-sm font-medium text-gray-400 hover:text-white rounded-xl hover:bg-white/[0.06] transition-all duration-150"
              >
